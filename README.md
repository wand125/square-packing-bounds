...
s(32) >= 47/8       = 5.875
s(38) >= 323/50     = 6.46
s(39) >= 329/50     = 6.58   (also n = 41)
s(40) >= 133/20     = 6.65   (also n = 41)
s(41) >= 164/25     = 6.56
s(42) >= 167/25     = 6.68
s(43) >= 677/100    = 6.77
s(44) >= 687/100    = 6.87
...
s(52) >= 1489/200   = 7.445
s(53) >= 373/50     = 7.46
s(54) >= 1529/200   = 7.645   (also n = 55)
s(55) >= 38/5       = 7.6
s(56) >= 153/20     = 7.65
s(57) >= 77/10      = 7.7
s(58) >= 194/25     = 7.76
s(59) >= 197/25     = 7.88   (also n = 60)
s(60) >= 3151/400   = 7.8775
s(61) >= 793/100    = 7.93
s(67) >= 837/100    = 8.37
s(69) >= 849/100    = 8.49
s(73) >= 431/50     = 8.62
...
| 21 | **4.97** | 497/100 | 20.990000 | `rect_n21_L497` | 4.880000 (jlevy/squares) | record | 10,177,596 |
| 26 | **5.52** | 138/25 | 25.990000 | `rect_n26_L552` | 5.508000 (tokoharu) | record | 13,209,164 |
| 27 | **5.5725** | 2229/400 | 26.990000 | `rect_n27_L55725` | 5.508000 (tokoharu) | record | 5,953,352 |
...
| 30 | **5.82** | 291/50 | 29.990000 | `rect_n30_L582` | 5.710000 (tokoharu) | record | 5,374,827 |
...
| 38 | **6.46** | 323/50 | 37.990000 | `rect_n38_L646` | 6.350603 (Green) | record | 7,175,684 |
| 39 | **6.58** | 329/50 | 38.990000 | `rect_n39_L658` | 6.500000 (this work) | record | 9,176,873 |
| 40 | **6.65** | 133/20 | 39.990000 | `rect_n40_L665` | 6.500000 (this work) | record | 9,253,732 |
| 41 | **6.56** | 164/25 | 40.990000 | `rect_n41_L656` | 6.500000 (this work) | record | 8,005,487 |
| 42 | **6.68** | 167/25 | 41.990000 | `rect_n42_L668` | 6.567764 (Nagamochi) | record | 9,754,978 |
| 43 | **6.77** | 677/100 | 42.990000 | `rect_n43_L677` | 6.656854 (Nagamochi) | record | 10,029,321 |
| 44 | **6.87** | 687/100 | 43.990000 | `rect_n44_L687` | 6.744563 (Nagamochi) | record | 10,895,871 |
| 45 | **6.945** | 1389/200 | 44.990000 | `rect_n45_L6945` | 6.830952 (Nagamochi) | record | 11,547,315 |
| 52 | **7.445** | 1489/200 | 51.990000 | `rect_n52_L7445` | 7.380000 (this work) | record | 10,670,814 |
| 53 | **7.46** | 373/50 | 52.990000 | `rect_n53_L746` | 7.380000 (this work) | record | 9,660,632 |
| 54 | **7.645** | 1529/200 | 53.990000 | `rect_n54_L7645` | 7.403124 (Nagamochi) | record | 16,212,903 |
| 55 | **7.6** | 38/5 | 54.990000 | `rect_n55_L76` | 7.540000 (this work) | record | 10,437,358 |
| 56 | **7.65** | 153/20 | 55.990000 | `rect_n56_L765` | 7.620000 (this work) | record | 10,386,925 |
| 57 | **7.7** | 77/10 | 56.990000 | `rect_n57_L77` | 7.633250 (Nagamochi) | record | 10,405,663 |
| 58 | **7.76** | 194/25 | 57.990000 | `rect_n58_L776` | 7.708204 (Nagamochi) | record | 10,937,250 |
| 59 | **7.88** | 197/25 | 58.990000 | `rect_n59_L788` | 7.782330 (Nagamochi) | record | 15,624,441 |
| 60 | **7.8775** | 3151/400 | 59.990000 | `rect_n60_L78775` | 7.855655 (Nagamochi) | record | 12,176,110 |
| 61 | **7.93** | 793/100 | 60.990000 | `rect_n61_L793` | 7.928203 (Nagamochi) | record | 13,070,494 |
| 67 | **8.37** | 837/100 | 66.990000 | `rect_n67_L837` | 8.289966 (Green) | record | 15,089,016 |
| 69 | **8.49** | 849/100 | 68.990000 | `rect_n69_L849` | 8.410000 (this work) | record | 16,391,943 |
